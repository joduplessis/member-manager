<?
	...
	array_push($lineData,$_GET['death']) ;
	...
	array_push($fieldNames,'date_death') ;
	...
	//IF THE GET - BACK VARIABLE IS SET - THEN THE WINDOW WILL USE THAT VALUE TO GO TO IN THE BROWSER
	if (isset($_GET['back'])) {
		print("<script>alert('Person Successfully Updated.');window.location='".$_SESSION['back']."';</script>");	
	} else {
		print("<script>alert('Person Successfully Updated.');window.location='community.add.php';</script>");	
	}
